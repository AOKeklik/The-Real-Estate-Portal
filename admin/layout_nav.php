...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right justify-content-end rightsidetop">
        <li class="nav-link">
            <a href="<?php echo BASE_URL?>index.php" target="_blank" class="btn btn-warning">Front End</a>
        </li>
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <?php else:?>
                    <img src="<?php echo PUBLIC_URL?>uploads/admin/<?php echo $_SESSION["admin"]["photo"]?>" alt="" class="rounded-circle-custom">
                <?php endif?>
            </a>
