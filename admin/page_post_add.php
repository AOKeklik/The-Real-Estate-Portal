        ...
        try{
            ...
            if(empty($errors)){
                ...
                try{
                    ...
                    $sql.="(".implode(",",$condition).") VALUES (?".str_repeat(",?", count($params) - 1).")";
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    <label>Excerpt</label>
                                    <textarea name="excerpt" class="form-control h_100" cols="30" rows="10"><?php if(isset($_POST["excerpt"])) echo $_POST["excerpt"]?></textarea>
