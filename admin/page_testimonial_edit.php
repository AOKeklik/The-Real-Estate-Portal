<?php
    ...
    try{
        ...
        if($stmt->rowCount() == 0) {
            $_SESSION["error"] = "The item you want to update does not exist.";
            header("Location: ".ADMIN_URL."testimonials");
            exit();
        }
        ...
        try{
            ...
            if(empty($errors)){
                ...
                try{
                    ...
                    if(!$stmt->execute([$photo,$full_name,$designation,$comment,$testimonial_id]))
                        throw new PDOException("An error occurred while updating the testimonial. Please try again later.");

                    $_SESSION["success"] = "The testimonial was updated successfully!";
                    header("Location: ".ADMIN_URL."testimonials");
                    exit();
                }catch(PDOException $err){
                    $error_message=$err->getMessage();
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-4">
                                        <img class="w-100" src="<?php echo PUBLIC_URL?>uploads/testimonial/<?php echo $testimonial["photo"]?>" alt="">
                                    </div>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group mb-3">
                                    <label>Name</label>
                                    <input type="text" class="form-control" name="full_name" value="<?php echo $testimonial["full_name"]?>">
                                ...
                                <div class="form-group mb-3">
                                    <label>Comment</label>
                                    <textarea name="comment" class="form-control h_100" cols="30" rows="10"><?php echo $testimonial["comment"]?></textarea>
